...
<head>
  ...
  <title>OpenBalance services</title>
        ...
        <tbody>
          ...
          <tr>
            ...
            <ul>
              ...
              <li><big><b>Services</b></big></li>

              <li><a href="virtualservers.php">Virtual
Servers</a></li>
      ...
      <table style="width: 95%;" border="0" cellpadding="2" cellspacing="0">
        ...
        <tbody>
          ...
          <tr>
            <td><a href='#' alt='Enable'><img border=0 style="width: 16px; height: 16px;" alt="Enable" title="Enable" src="images/lightbulb_off.png"></a> <a href='#' alt='Edit'><img style="width: 16px; height: 16px;" border=0 alt="Edit" title="Edit" src="images/server_edit.png"></a> <a href='#'><img border=0 style="width: 16px; height: 16px;" alt="Copy" title="Copy" src="images/server_go.png"></a> <a href='#'><img border=0 style="width: 16px; height: 16px;" alt="Delete" title="Delete" src="images/server_delete.png"></a></td>

            <td>Server Two - http</td>
          ...
          <tr>
            ...
            <a href='javascript:addServiceDlg.show()' alt='Add'><img border=0 style="width: 16px; height: 16px;" alt="Add" title="Add" src="images/server_add.png"> Add New Service</a>
            </td>
